...
urlpatterns = [
    ...
    # ROTAS DE REDEFINIÇÃO DE SENHA (CORRIGIDA)
    path(
        'password_reset/',
        auth_views.PasswordResetView.as_view(
            # CORREÇÃO CRÍTICA: Deve-se usar reverse_lazy para evitar que 'users' seja interpretado como um protocolo,
            # o que causou o DisallowedRedirect.
